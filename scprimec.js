...
// Other parameters
var webpath = './pweb/data/'
var currentFilePath = webpath + "scprimenow.json"
var evolutionFilePath = webpath + "scprimeevo.json"

// Initial log lines
console.log()
console.log("---------------------------------------------")
console.log("+          SCPrime Status            +")
console.log("+                                    +")
console.log("+                                    +")
console.log("---------------------------------------------")
console.log()
console.log("Scaning data every 10 minutes")
...
var cronJob2 = cron.job("00 05 00 * * *", function(){
    ...
    stream1.on('end', function() {
        ...
        stream2.on('error', function() {
            console.log("Creating new scprime_evo file")
            evoArray = []
            saveEvoFile(currentStats, evoArray)
        })
    ...
    stream1.on('error', function() {
        console.log("** Error opening scprime_evo file")
    })
    ...
    function saveEvoFile(currentStats, evoArray) {
        ...
        var evoEntry = {
            time: timestamp,
            primeused: currentStats[0].usedstorage,
            primetotal: currentStats[0].totalstorage,
            primehosts: currentStats[0].activehosts,
            primehash: currentStats[0].hashrate,
            primeused_online: currentStats[0].usedstorage_online,
            primetotal_online: currentStats[0].totalstorage_online,
            primehosts_online: currentStats[0].onlinehosts,
